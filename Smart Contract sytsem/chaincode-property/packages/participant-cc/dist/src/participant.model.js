...
var x509Identities = (function (_super) {
    ...
    tslib_1.__decorate([
        convector_core_1.Validate(yup.boolean()), convector_core_1.Required()
    ], x509Identities.prototype, "status", void 0);
    tslib_1.__decorate([
        convector_core_1.Validate(yup.string()), convector_core_1.Required()
...
var Participant = (function (_super) {
    ...
    tslib_1.__decorate([
        convector_core_1.ReadOnly(), convector_core_1.Required(),
        convector_core_1.Validate(yup.string())
    ], Participant.prototype, "name", void 0);
    tslib_1.__decorate([
        convector_core_1.ReadOnly(), convector_core_1.Validate(yup.string())
