...
export const externalURL = process.env.EXTERNAL_URL || 'http://demo0748406.mockable.io/_____';

export const chaincode = process.env.CHAINCODE || 'property';
export const channel = process.env.CHANNEL || 'ch1';
export const oracleEventToListen = process.env.CHANNEL || 'ch1';
